...
for LOIter=1:maxLOIter
    ...
    [C isConverged time step] = nonline ar_alpha_beta_weighted_fixedAB(I, W(probes_keep,arrays_keep), A(probes_keep), B(probes_keep), alpha, beta, maxIterCnt, eps, alpha_C, use_term_criteria);
