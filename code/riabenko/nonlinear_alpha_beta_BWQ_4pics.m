function [A B C isConverged qual_hist C_max_hist B_max_hist A_max_hist corr_B_hist test_qual_hist time iter_cnt] = nonlinear_alpha_beta_BWQ_4pics(I, alpha, beta, maxIterCnt, eps, ...
        alpha_B, index, use_term_criteria, I_test)
    if (nargin < 8)
