function [A B C  C_dist_all B_dist_all A_dist_all] = nonlinear_alpha_beta_BWQ_dists(I, alpha, beta, maxIterCnt, eps, ...
        alpha_B, index, use_term_criteria)
    if (nargin < 8)
