function [A B C isConverged qual_hist C_max_hist B_max_hist A_max_hist corr_B_hist test_qual_hist] = nonlinear_alpha_beta_reg_derivative_4pics(I, alpha, beta, maxIterCnt, eps, ...
...
%                (alpha + beta + 1) * ((F + eps) .^ alpha)), 2));
        ...
        C_test = nonlinear_alpha_beta_reg_derivative_fixedAB(I_test, A, B, alpha, beta, maxIterCnt, eps, alpha_reg, 1);
