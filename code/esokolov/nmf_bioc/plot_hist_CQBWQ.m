...
for alpha_B_idx = 1:length(alpha_B_range)
    ...
    parfor ind = 1:(length(alpha_C_range)*length(probesets))
        ...
        [A B C isConverged qual_hist_curr(ind, :) C_max_hist_curr(ind, :) ...
            ...
            nonlinear_alpha_beta_CQBL_4pics(I(:, 1:100), alpha, beta, maxIterCnt, 1e-6, alpha_B, alpha_C, 0, I(:, 901:end));
    ...
    save('plot_hist_CQBWQ_100arrays_10probesets.mat', 'qual_hist_all', 'C_max_hist_all', 'B_max_hist_all', 'A_max_hist_all', 'corr_B_hist_all', 'test_err_all');
end
